...
<body id="home">
  ...
  <nav class="navbar-container">
    <div class="navbar-logo">
      <h3><a href="./">Toko Jimmi Collection</a></h3>
    </div>
    ...
    <div class="header-content">
      <div class="row">
        <div class="col-md-5 my-auto mx-auto" data-aos="fade-right">
          ...
          <p>
            Toko Jimi Collection adalah toko online yang menjual berbagai macam produk sendal 
        ...
        <div class="col-md-6 my-auto mx-auto" data-aos="zoom-in">
          <div class="d-flex justify-content-center align-items-center flex-column">
            <img src="assets/img/video-sendal.gif" alt="banner" class="my-5">
          </div>
        </div>
      </div>
    </div>
